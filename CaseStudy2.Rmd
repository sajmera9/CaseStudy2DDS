...
#Final Linear Model with RMSE of 1002
finalfit = lm(MonthlyIncome ~ TotalWorkingYears*factor(JobLevel)+DailyRate*factor(JobRole),data = newemp.data)
summary(finalfit)

#Saved predictions into a dataframe and wrote to csv
salary_preds=predict(finalfit, newdata = case2.no.salary)

my_submissionB = tibble("ID"= case2.no.salary$ID, "Attrition" = salary_preds)
